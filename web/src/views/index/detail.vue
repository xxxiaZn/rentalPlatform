          ...
          <div class="thing-infos-view">
            <div class="thing-infos">
              <div class="thing-img-box">
                <img :src="detailData.cover" :style="{ width: '600px', height: '600px' }" />
              </div>
              <div class="thing-info-box">
                ...
                <span>
                  ...
                  <span class="a-price" style="font-size: 35px">{{ detailData.price }}</span>
                  <span> 元/天</span>
                </span>
                ...
                <el-popover :visible="visible" placement="right" :width="400">
                  <p>请选择租赁日期：</p>
                  ...
                  <div style="text-align: right; margin: 0">
                    ...
                    <el-button size="large" type="primary" @click="visible = false; handleOrder(detailData)">
                      预订
                    </el-button>
                  </div>
                  <template #reference>
                    <el-button type="primary" size="large" @click="visible = true" style="margin-top: 20px;">立即预定</el-button>
                  </template>
                </el-popover>
              </div>
            </div>
              ...
              <div class="thing-item thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                ...
                <div class="info-view">
                  ...
                  <span>
                    ...
                    <span class="a-price-symbol">元/天</span>
                  </span>
                </div>
              </div>
            </div>
...
<script lang="ts" setup>
  ...
  const handleOrder = (detailData) => {
    ...
    if (userId && value1.value.length === 2) {
      const [startDate, endDate] = value1.value;
      const startdate = formatDateToBackend(startDate);
      const enddate = formatDateToBackend(endDate);
      /* console.log(startdate);
      console.log("#")
      console.log(enddate);
      console.log(detailData.price) */
      ...
      updateApi({id: thingId.value}, formData1)
