...
urlpatterns = [
    ...
    path('admin/fankuicontent/list', views.admin.fankuicontent.list_api),   #反馈后台
    path('admin/repairwork/list', views.admin.repairwork.list_api), #维修后台
    path('admin/repairwork/complete_repair', views.admin.repairwork.complete_repair),
    path('admin/maintainance/list', views.admin.maintainance.list_api), #保养后台
    ...
    path('index/order/return_', views.index.order.return_),
    ...
    path('index/fankuicontent/create', views.index.fankuicontent.create),   #反馈前台
    path('index/repair/create_repair', views.index.repair.create_repair),   #维修前台
    path('index/maintainance/create', views.index.maintainance.create),     #保养前台
]
