...
class Address(models.Model):
    ...
    class Meta:
        db_table = "b_address"
#反馈
class Fankuicontent(models.Model):
    id = models.BigAutoField(primary_key=True)
    fankuicontent = models.CharField(max_length=100, blank=True, null=True)
    order_number = models.CharField(max_length=100, blank=True, null=True)
    fankuitime = models.DateTimeField(auto_now_add=True, null=True)

    class Meta:
        db_table = "fankuicontent"
#维修
...
class Maintainance(models.Model):
    id = models.BigAutoField(primary_key=True)
    order = models.ForeignKey(Order, on_delete=models.CASCADE, null=True, related_name='order_maintainance')
    thing = models.ForeignKey(Thing, on_delete=models.CASCADE, null=True, related_name='thing_maintainance')
    order_number = models.CharField(max_length=13, blank=True, null=True)
    thing_title = models.CharField(max_length=100, blank=True, null=True)
    maintainance_date = models.DateTimeField(null=True)

    class Meta:
        db_table = "b_maintainance"